...
describe "Simon says" do
  ...
  describe "repeat" do
    ...
    it "(2) should repeat a number of times" do
  ...
  describe "titleSize" do
    it "capitalizes a word" do
      expect(titleSize("jaws")).to eq("Jaws")
    end

    it "capitalizes every word (aka title case)" do
      expect(titleSize("david copperfield")).to eq("David Copperfield")
    end

    it "doesn't capitalize 'little words' in a title" do
      expect(titleSize("war and peace")).to eq("War and Peace")
    end

    it "does capitalize 'little words' at the start of a title" do
      expect(titleSize("the bridge over the river kwai")).to eq("The Bridge Over the River Kwai")
    end
  end
end
